...
export const TopCompanies = () => {
  // برای ایجاد ریل متحرک بدون پرش، آرایه رو ۳ بار تکرار می‌کنیم
  const duplicatedCompanies = [...COMPANIES, ...COMPANIES, ...COMPANIES];

  return (
    <section className="relative w-full py-20 bg-[#f8fafc] overflow-hidden">
      
      {/* انیمیشن شیشه‌ای درخشان + انیمیشن ریل متحرک */}
      <style dangerouslySetInnerHTML={{__html: `
        ...
        @keyframes scroll {
          ...
          100% { transform: translateX(calc(100% / 3)); } /* حرکت به راست به دلیل RTL بودن */
        }
        .animate-scroll {
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* =========================================
            ۱. بنر فوق‌حرفه‌ای و لوکس بالای کارت‌ها (دقیقاً حفظ شد)
            ========================================= */}
        ...
        {/* =========================================
            ۲. ریل متحرک (Marquee) با کارت‌ها و لوگوهای بزرگ
            ========================================= */}
        <div className="relative w-full overflow-hidden flex items-center py-4 -mx-4 px-4">
          
          {/* گرادیانت‌های محو کننده چپ و راست (ایجاد حس تونل) */}
          <div className="absolute top-0 left-0 w-16 sm:w-32 h-full bg-gradient-to-r from-[#f8fafc] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute top-0 right-0 w-16 sm:w-32 h-full bg-gradient-to-l from-[#f8fafc] to-transparent z-10 pointer-events-none"></div>

          <div className="flex animate-scroll gap-4 sm:gap-6 lg:gap-8" dir="rtl">
            {duplicatedCompanies.map((company, index) => (
              ...
              >
                ...
                <div className="relative z-20 flex h-full w-full flex-col items-center justify-center p-4 sm:p-6">
                  ...
                  {/* لوگو دقیقاً همون سایز بزرگ قبلی موند */}
                  <img 
